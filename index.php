...
<head>
    ...
    <title>SandarScout | Sandi Kotak 1</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous">
    <link rel="stylesheet" href="https://tekpram.sandarscout.com/sandikotaksatu/assets/css/style.css">
    <link rel="icon" href="https://sandarscout.com/wp-content/uploads/2021/03/sandarscout-16x16-1.png" type="image/png" sizes="16x16"/>
</head>
<body>
    <div class="container">
    <center>
        <H1>LATIHAN SOAL SANDI KOTAK 1</H1>
        <p>All rights reserved by Sandar Scout</p> <br>
        hallo teman-teman ini adalah tool untuk membuat soal sandi kotak 1 <br>
          ...
          <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                ...
                <center>
                    ...
                    <h3 style="overflow-x: auto; color: red;"><?php echo strtoupper($soal) ?></h3>
                </center>
            </div>
            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                <center>
                    Kunci Jawaban Untuk Soal <br>
                    <h3 style="overflow-x: auto;"><?php echo strtoupper($soal) ?></h3> <br>
                    adalah <br>
